/**
 * @name Nightcord
 * @description More features for the Nightcord theme.
 * @author tomoya#0329
 * @authordId 229040367863857152
 * @authordLink https://twitter.com/riamuyumemi
 * @version 0.0.1
 */
...
const config = {
    info: {
        ...
        github_raw:
            "https://raw.githubusercontent.com/Neodymium7/BetterDiscordStuff/main/ActivityIcons/ActivityIcons.plugin.js",
    },
    // changelog: [
    //     {
    //         title: "Fixed",
...
// const hashtag = document.querySelector(
    ...
    (() => {
        var __webpack_modules__ = {
            161: (module, __webpack_exports__, __webpack_require__) => {
                ...
                var styles__WEBPACK_IMPORTED_MODULE_2__ =
                ...
                (0, styles__WEBPACK_IMPORTED_MODULE_2__.z)(
                    "styles.css",
        ...
        (() => {
            ...
            var external_ActivityIcons_default = __webpack_require__.n(
                external_ActivityIcons_namespaceObject
            );
            class SettingsManager {
                constructor(defaultSettings) {
                    this.settings = (0,
                    external_BdApi_namespaceObject.loadData)(
                        external_ActivityIcons_default(),
                        "settings"
                    );
                    if (!this.settings) {
                        (0, external_BdApi_namespaceObject.saveData)(
                            external_ActivityIcons_default(),
                            "settings",
                            defaultSettings
                        );
                ...
                useSettingState(key) {
                    const [setting, setSetting] = (0,
                    external_BdApi_React_.useState)(this.get(key));
                    (0, external_BdApi_React_.useEffect)(
                        () =>
                            this.addListener((changedKey, value) => {
                ...
                useSettingsState() {
                    ...
                    external_BdApi_React_.useState)(this.settings);
                    (0, external_BdApi_React_.useEffect)(
                        () =>
                            this.addListener((changedKey, value) => {
            ...
            function forceUpdateAll(selector) {
                document.querySelectorAll(selector).forEach((node) => {
                    external_Library_namespaceObject.ReactTools.getStateNodes(
                        node
                    ).forEach((e) => e.forceUpdate());
                });
            }
            ...
            const Activity = getModule(
                byStrings(
                    "M5.79335761,5 L18.2066424,5 C19.7805584,5 21.0868816,6.21634264"
                )
            );
            const RichActivity = getModule(
                byStrings("M6,7 L2,7 L2,6 L6,6 L6,7 Z M8,5 L2,5 L2,4 L8,4")
            );
            ...
            function ActivityIcon(props) {
                ...
                const isBot =
                    1 === activities.length &&
                    0 === activities[0].type &&
                    Object.keys(activities[0]).every(
                        (value, i) => value === bot[i]
                    );
                if (isBot || 0 === activities.length) return null;
                const normalActivities = props.activities.filter(
                    (activity) => 0 === activity.type
                );
                const hasCustomStatus = props.activities.some(
                    (activity) => 4 === activity.type && activity.state
                );
                const hasRP = normalActivities.some(
                    (activity) =>
                        (activity.assets || activity.details) &&
                        !activity.platform
                );
                const onPS = normalActivities.some(
                    (activity) =>
                        "ps5" === activity.platform ||
                        "ps4" === activity.platform
                );
                const onXbox = normalActivities.some(
                    (activity) => "xbox" === activity.platform
                );
                if (0 === normalActivities.length) return null;
                if (2 === normalIconBehavior && !(hasRP || onPS || onXbox))
                    return null;
                if (
                    1 === normalIconBehavior &&
                    !hasCustomStatus &&
                    !(hasRP || onPS || onXbox)
                )
                    return null;
                let tooltip;
                if (1 === normalActivities.length && hasCustomStatus)
                    tooltip = ActivityIcon_React.createElement(
                        "strong",
                        null,
                        normalActivities[0].name
                    );
                else if (2 === normalActivities.length)
                    tooltip = ActivityIcon_React.createElement(
                        ActivityIcon_React.Fragment,
                        null,
                        ActivityIcon_React.createElement(
                            "strong",
                            null,
                            normalActivities[0].name
                        ),
                ...
                if (onPS)
                    icon = ActivityIcon_React.createElement(playstation, {
                        width: "14",
                        height: "14",
                        className: "activity-icon-small",
                    });
                if (onXbox)
                    icon = ActivityIcon_React.createElement(xbox, {
                        width: "14",
                        height: "14",
                        className: "activity-icon-small",
                    });
                if (hasRP)
                    icon = ActivityIcon_React.createElement(RichActivity, {
                        width: "16",
                        height: "16",
                    });
                return tooltip
                          ...
                          (props2) =>
                              ActivityIcon_React.createElement(
                                  "div",
                                  {
                                      ...props2,
                                      className: hasRP
                                          ? "activity-icon rich-activity-icon"
                                          : "activity-icon",
                                  },
                                  icon
                              )
            ...
            const Headset = ListeningIcon_getModule(
                ListeningIcon_byStrings(
                    "M12 2.00305C6.486 2.00305 2 6.48805 2 12.0031V20.0031C2"
                )
            );
            const ListeningIcon_Tooltip = ListeningIcon_getModule(
                ListeningIcon_byPrototypeFields("renderTooltip")
            );

            function ListeningIcon(props) {
                const activity = props.activities.filter(
                    (activity2) => 2 === activity2.type
                )[0];
                if (!activity) return null;
                return ListeningIcon_React.createElement(
                    ListeningIcon_Tooltip,
                    {
                        text: ListeningIcon_React.createElement(
                            ListeningIcon_React.Fragment,
                            null,
                            ListeningIcon_React.createElement(
                                "div",
                                {
                                    style: {
                                        fontWeight: "600",
            ...
            const RadioGroup = SettingsPanel_getModule(
                (m) => m.Sizes && m.toString().includes("radioItemClassName")
            );
            const SettingsItem = SettingsPanel_getModule(
                (m) => m.Tags && m.toString().includes("required")
            );
            const SettingsNote = SettingsPanel_getModule(
                (m) => m.Types && m.toString().includes("selectable")
            );

            function SettingsPanel() {
                const settings = Settings.useSettingsState();
                return SettingsPanel_React.createElement(
                    SettingsPanel_React.Fragment,
                    null,
                    SettingsPanel_React.createElement(
                        SettingsItem,
                        {
                        ...
                        SettingsPanel_React.createElement(RadioGroup, {
                            options: [
                                {
            ...
            const {
                Filters: { byProps: src_byProps, byStrings: src_byStrings },
                getModule: src_getModule,
            } = external_BdApi_namespaceObject.Webpack;
            const peopleListItem = `.${
                src_getModule(src_byProps("peopleListItem")).peopleListItem
            }`;
            const memberListItem = `${external_Library_namespaceObject.DiscordSelectors.MemberList.members} > div > div:not(:first-child)`;
            const privateChannel = `.${
                src_getModule(src_byProps("privateChannelsHeaderContainer"))
                    .scroller
            } > ul > li`;
            class ActivityIcons extends external_BasePlugin_default() {
                onStart() {
                    (0, external_BdApi_namespaceObject.injectCSS)(
                        "ActivityIcons",
                        styles.Z
                    );
                ...
                patchActivityStatus() {
                    const ActivityStatus = src_getModule(
                        withProps(src_byStrings("applicationStream"))
                    );
                    external_BdApi_namespaceObject.Patcher.after(
                        "ActivityIcons",
                        ActivityStatus,
                        "Z",
                        (_, [props], ret) => {
                            if (ret) {
                                ...
                                ret.props.children.push(
                                    src_React.createElement(ActivityIcon, {
                                        activities: props.activities,
                                    })
                                );
                                ret.props.children.push(
                                    src_React.createElement(ListeningIcon, {
                                        activities: props.activities,
                                    })
                                );
                            }
                ...
                onStop() {
                    external_BdApi_namespaceObject.Patcher.unpatchAll(
                        "ActivityIcons"
                    );
                    (0, external_BdApi_namespaceObject.clearCSS)(
                        "ActivityIcons"
                    );
                    forceUpdateAll(memberListItem);
                    forceUpdateAll(peopleListItem);
